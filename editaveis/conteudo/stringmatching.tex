...
\subsubsection*{Sørensen–Dice coefficient} % (fold)
\label{ssub:s_rensen_dice_coefficient}

Também conhecido como \textit{indice de Sørensen} ou \textit{Coeficiente de Dice}, o algoritmo que faz de uso de análise estatistica foi independentemente desenvolvido por \citeonline{sorensen1948method} e \citeonline{dice1945measures} para analise  de estudos amostras. O modelo propõe o uso de \textit{bigrams}, um subgrupo de \textit{n-grams}\cite{cavnar1994n}, para calcular a proximidade entre duas \textit{strings} contando as intersecções entre elas.

Matematicamente, o comparativo é realizado com a intersecção de conjuntos:
