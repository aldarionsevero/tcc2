\section{\nmu Algorítimos de  \textit{string matching}} % (fold)
...
No \autoref{kmpalgoritm} podemos observar o algorítimo de Knuth–Morris–Pratt genericamente aplicado.
