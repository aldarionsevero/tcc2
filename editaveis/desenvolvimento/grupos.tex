...
\noindent\begin{minipage}{\textwidth}
  \lstset{style=shell}
  \lstinputlisting[language=Ruby, frame=single, label=code:grouptemplate, caption="Template para os blocos de recursos de grupo Chef"]{editaveis/code/grouptemplate.rb}
\end{minipage}\hfill
