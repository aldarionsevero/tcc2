...
\noindent\begin{minipage}{\textwidth}
  ...
  \lstinputlisting[frame=single,
    label=code:json_pkg,
    caption="Saída JSON do plugin Ohai \textit{packages}"]{editaveis/code/json_pkg.json}
\end{minipage}\hfill
...
\noindent\begin{minipage}{\textwidth}
  ...
  \lstinputlisting[frame=single,
    ...
    caption="Saída JSON do plugin Ohai \textit(pacman)"]{editaveis/code/json_pkg_pacman.json}
\end{minipage}\hfill
